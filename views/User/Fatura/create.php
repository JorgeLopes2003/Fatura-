...
<div style="margin-left:10%; margin-top:1%;" class="col-sm-6 text-center">
    ...
    <form action='index.php?r=fatura/storefinalizar&&id=<?= $fatura->id ?>' method="post" style="width:80vw;">
        ...
        <select style="width:150px; margin-left:44%" class="form-control mb-3 text-center" name="referencia_cliente" id="referencia_cliente">
        ...
        <a href="index.php?r=fatura/storedepois&&id=<?= $fatura->id ?>" class="btn btn-info" role="button" style="margin-left:80%">Finalizar Depois</a>
    </form>
    <br>
