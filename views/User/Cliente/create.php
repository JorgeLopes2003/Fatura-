<div class="container">
    <br>
    <br>
    <h2 class="row justify-content-center">Registar Novo Cliente ! </h2>
    <form action="index.php?r=store/cliente" method="post" class="needs-validation row justify-content-center" novalidate>
        <div class="col col-6">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="password" name="password" value="<?php if(isset($user)){
                    echo $user->password;
                }?>" required>
            ...
            <button type="submit" class="btn btn-info">Criar Novo Cliente</button>
        </div>
    </form>
    <br>
    <br>
